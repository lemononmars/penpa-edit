...
export function inferredMarkChoice(variation: Variation): VariantMarkChoice {
    ...
    if (["anti king", "anti knight", "disjoint", "queen", "disparity", "liardiagonal", "magicsquares", "onefivenine", "unicorn", "citywalk", "poleposition", "pole position" , "sequence top-bottom"].includes(variation.value)) {
