...
export function inferredMarkChoice(variation: Variation): VariantMarkChoice {
    ...
    if (["anti king", "anti knight", "disjoint", "queen", "disparity", "liardiagonal", "magicsquares", "onefivenine", "unicorn", "citywalk", "poleposition", "pole position"].includes(variation.value)) {
