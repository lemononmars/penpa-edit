...
const PenpaText = {
    ...
    _innerText: [
        ...
        'lb_settings_primary_color',
        'lb_settings_primary_color_blue',
        'lb_settings_primary_color_green',
        'lb_settings_primary_color_orange',
        'lb_settings_primary_color_pink',
        'lb_settings_primary_color_grey',
    ...
    dictionary: {
        ...
        lb_settings_primary_color: {EN: 'Color Theme:', JP: 'カラーテーマ', ZH: '颜色主题'},
        lb_settings_primary_color_blue: {EN: 'Blue', JP: '青', ZH: '蓝色'},
        lb_settings_primary_color_green: {EN: 'Green', JP: '緑', ZH: '绿色'},
        lb_settings_primary_color_orange: {EN: 'Orange', JP: 'オレンジ', ZH: '橙色'},
        lb_settings_primary_color_pink: {EN: 'Pink', JP: 'ピンク', ZH: '粉色'},
        lb_settings_primary_color_grey: {EN: 'Grey', JP: 'グレー', ZH: '灰色'},
