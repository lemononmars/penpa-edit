...
for(const name of ['20260918000000_wsc2026_practice.sql','20260919000000_wsc2026_single_team.sql'])await db.exec(fs.readFileSync('supabase/migrations/'+name,'utf8'));
...
console.log('PASS single team, password enforcement, five-member cap, private records, no legacy RPC bypass');await db.close();
