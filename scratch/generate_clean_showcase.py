...
% Standardized Table Header for Individual Puzzles (Prominent & High-Contrast)
\newcommand{\lshead}[3]{%
  \noindent
  \begin{tblr}{
    colspec = {Q[c,m,18mm]X[l,m]Q[c,m,26mm]},
    column{1} = {bg=cbdarkteal, font=\bfseries\normalsize\color{white}},
    column{2} = {bg=white, font=\bfseries\normalsize\color{cbdarkteal}},
    column{3} = {bg=cbteal!20, font=\bfseries\small\color{cbdarkteal}},
    hlines = {0.8pt, cbdarkteal},
    vlines = {0.8pt, cbdarkteal},
...
\newcommand{\lsheads}[3]{%
  ...
  \begin{tblr}{
    ...
    column{1} = {bg=cbdarkteal, font=\bfseries\small\color{white}},
    column{2} = {bg=white, font=\bfseries\small\color{cbdarkteal}},
    column{3} = {bg=cbteal!20, font=\bfseries\scriptsize\color{cbdarkteal}},
    hlines = {0.6pt, cbdarkteal},
    vlines = {0.6pt, cbdarkteal},
    rows = {abovesep=1.5pt, belowsep=1.5pt}
  }
  #1 & #2 & #3 \\
  \end{tblr}%
  \par\vspace{0.8mm}%
...
% Mini Header for 3-column rows without text wrapping
\newcommand{\lsheadmini}[2]{%
  \noindent
  \begin{tblr}{
    colspec = {Q[c,m,12mm]X[c,m]},
    column{1} = {bg=cbdarkteal, font=\bfseries\small\color{white}},
    column{2} = {bg=white, font=\bfseries\small\color{cbdarkteal}},
    hlines = {0.6pt, cbdarkteal},
    vlines = {0.6pt, cbdarkteal},
...
\thispagestyle{fancy}
\begin{center}
{\fontsize{26}{30}\selectfont \textbf{\color{cbdarkteal}Logic Showcase}}\\[2mm]
{\fontsize{13}{16}\selectfont \textbf{\color{black!75}Avant-Garde Hybrid Logic Exhibition (LS 49 -- LS 75)}}\\[3mm]
...
\begin{tcolorbox}[
  ...
  boxrule=0.9pt,
  arc=2mm,
  left=5mm, right=5mm, top=4mm, bottom=4.5mm
]
\raggedright
{\normalsize\textbf{\color{cbdarkteal}Welcome to the Logic Showcase Exhibition!}}\\[2mm]
{\small The Logic Showcase series serves as a laboratory for avant-garde pencil-and-paper logic puzzles. Ranging from \textbf{LS 49} to \textbf{LS 75}, these 47 curated compositions push classical mechanics into uncharted mathematical territories:
\begin{itemize}
...
\raggedright
\textbf{\footnotesize Solving Instructions \& Verification Notation:}\\[1.5mm]
{\footnotesize
\begin{itemize}
...
% =========================================================================
\begin{center}
{\Large \textbf{\color{cbdarkteal}Logic Showcase Catalog \& Index (LS 49 -- LS 75)}}\\[2mm]
...
\begin{tblr}{
  ...
  column{1} = {font=\bfseries\color{cbdarkteal}},
  column{3} = {font=\bfseries\color{cbdarkteal}},
...
\begin{itemize}
  ...
  \item Shade some cells so all shaded cells form one connected area without 2×2 shaded squares.
...
\centering
\textbf{Example (6×6)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls49_twilight_canal_view_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls49_twilight_canal_view_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\centering
\textbf{Example (6×6)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls49_twilight_kurodoko_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls49_twilight_kurodoko_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\centering
\textbf{Example (6×6)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls50_l_voxas_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls50_l_voxas_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\centering
\textbf{Example (6×6)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls50_l_dots_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls50_l_dots_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\raggedright
\footnotesize
\textbf{Rules:} Place digits 1 to 6 once per row and column. Outer clues indicate visible buildings. Grids next to each side represent clue candidates. Shade invalid candidates, unshade correct ones. Revealing an arrow forces shading the neighboring cell it points to.
...
\centering
\textbf{Puzzle Grid (18×18)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 16\cellsize\relax]{ls51_skyscrapers_puzzle.pdf}
\end{minipage}
...
\centering
\textbf{Puzzle Grid (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls51_slitherlink_polygraph_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 15\cellsize\relax]{ls51_choco_banana_treasure_hunt_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.35\linewidth}\vspace{0pt}
\centering
\textbf{Example (5×5)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 5\cellsize\relax]{ls52_foreshadow_crossing_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls52_foreshadow_crossing_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\begin{minipage}[t]{0.46\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls52_remembered_choco_frozen_banana_puzzle.pdf}
\end{minipage}
...
\vspace{2mm}
\centering
\textbf{Example (7×7)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 9\cellsize\relax]{ls53_pentominous_outside_example.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.54\textwidth}\vspace{0pt}
\centering
\textbf{Puzzle (15×15)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 18\cellsize\relax]{ls53_pentominous_outside_puzzle.pdf}
\end{minipage}
...
\centering
\textbf{Example (7×7)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 7\cellsize\relax]{ls54_guide_exit_example.pdf}
\end{minipage}\hfill
\begin{minipage}[t]{0.61\linewidth}\vspace{0pt}
\centering
\textbf{Puzzle (12×12)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 12\cellsize\relax]{ls54_guide_exit_puzzle.pdf}
\end{minipage}
\end{minipage}
...
\begin{minipage}[t]{0.46\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls54_ice_walk_delayed_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls55_kurotto_banana_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls55_disorderly_tapa_like_loop_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.50\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls57_instructionless_puzzle.pdf}
\end{minipage}
...
\lsheadmini{6.16}{Pentominous I}
\vspace{0.5mm}
\scriptsize\raggedright
\textbf{Rules:} Divide into pentominoes (5 cells). Matching shapes cannot touch orthogonally. Letters mark shapes.
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls58_puzzle_1_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}\vspace{0pt}
\lsheadmini{6.17}{Pentominous II}
\vspace{0.5mm}
\scriptsize\raggedright
\textbf{Rules:} Divide into pentominoes. Non-touching shape rule. Clues indicate polyomino shapes.
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls58_puzzle_2_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}\vspace{0pt}
\lsheadmini{6.18}{Pentominous III}
\vspace{0.5mm}
\scriptsize\raggedright
\textbf{Rules:} Pentominous rules apply. Clues use vertical bar symbols indicating pentomino shapes.
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls58_puzzle_3_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls59_territory_one_square_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls59_choco_banana_one_square_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls59_balance_loop_hidden_white_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls60_canal_view_connected_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls60_masyu_connected_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls61_contact_equal_sign_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls61_contact_plus_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls61_contact_lenses_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls61_rampage_tilted_square_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls61_rampage_ox_loops_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls61_rampage_roadblocks_puzzle.pdf}
\end{minipage}
...
\lsheadmini{6.30}{Spiral}
\vspace{0.4mm}
\scriptsize\raggedright
Turn indicators.
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 7\cellsize\relax]{ls61_turnaround_spiral_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}\vspace{0pt}
\lsheadmini{6.31}{9×9 Grid}
\vspace{0.4mm}
\scriptsize\raggedright
Sequential turn rules.
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 9\cellsize\relax]{ls61_turnaround_9x9_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.33\textwidth}\vspace{0pt}
\lsheadmini{6.32}{12×12 Grid}
\vspace{0.4mm}
\scriptsize\raggedright
Full traversal loop.
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 12\cellsize\relax]{ls61_turnaround_12x12_puzzle.pdf}
\end{minipage}
...
\centering
\textbf{Example (6×6)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 6\cellsize\relax]{ls63_slitherlink_turnaround_full_example.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.54\textwidth}\vspace{0pt}
\centering
\textbf{Puzzle Grid (10×10)}\\[1.2mm]
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls63_slitherlink_turnaround_full_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls64_mirror_loop_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.56\textwidth}\vspace{0pt}
\scriptsize\raggedright
\textbf{Rules:} Shade cells so all shaded cells form one connected area without 2×2 shaded squares. Clues cannot be shaded and indicate the lengths of consecutive shaded blocks along the length of rope attached to the clue.
\end{minipage}
\hfill
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 12\cellsize\relax]{ls65_tapa_rope_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.56\textwidth}\vspace{0pt}
\scriptsize\raggedright
\textbf{Rules:} Canal View rules apply (shaded connected, no 2×2). Clues cannot be shaded and count shaded cells in orthogonal lines. A question mark (?) is an unknown positive number. In addition, each bold region contains exactly two separate connected shaded groups.
\end{minipage}
\hfill
\begin{minipage}[t]{0.42\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls66_canal_view_disco_puzzle.pdf}
\end{minipage}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls67_pentominous_partial_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls67_choco_banana_inequality_puzzle.pdf}
\end{minipage}
...
\showcaseheadermini{LS 68: Pattern Square Series}{Latin-square style distribution of distinct 2×2 shaded polyomino patterns.}

\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
\lsheads{6.39}{Pattern Square (Size)}{LS 68}
\vspace{0.5mm}
\scriptsize\raggedright
\textbf{Rules:} Shade cells so each of six 2×2 shading patterns (or rotations) appears once per row/column of 2×2 bold regions. Clues are shaded and indicate group size.
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls68_pattern_square_size_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1.2mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls68_pattern_square_cts_puzzle.pdf}
\end{minipage}
...
\begin{minipage}[t]{0.46\textwidth}\vspace{0pt}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls69_yajiring_ring_puzzle.pdf}
\end{minipage}
...
\begin{itemize}
  \setlength{\itemsep}{1.2pt}
  \item Draw a snake (1-cell wide path) through letters without touching itself, even diagonally.
  \item The snake must visit all letters of every word in the vocabulary in sequential order.
\end{itemize}
\vspace{2mm}
\centering
\textbf{Example (4 Rows)}\\[1.2mm]
\includegraphics[height=\dimexpr 4\cellsize\relax, keepaspectratio]{ls70_alphabet_asp_example.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.54\textwidth}\vspace{0pt}
\centering
\textbf{Puzzle Grid (9 Rows)}\\[1.2mm]
...
\begin{tcolorbox}[
  ...
  {\scriptsize
  $\bullet$ \textbf{Dimensions:} 10 columns × 50 vertical stories.\\
...
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls72_pencils_look_air_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls73_pentominous_myopia_puzzle.pdf}
\end{minipage}
...
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 8\cellsize\relax]{ls74_choco_banana_thermo_puzzle.pdf}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}\vspace{0pt}
...
\vspace{1mm}
\centering
\includegraphics[valign=t, width=\dimexpr 10\cellsize\relax]{ls75_pentominous_irrwisch_puzzle.pdf}
\end{minipage}

'''

pb_showcase = r"C:\Users\sakul_bp6myy0\OneDrive\Downloads\Puzzles\CB Puzzle Contest\2026\pb\logic_showcase.tex"
with open(pb_showcase, "w", encoding="utf-8") as f:
    f.write(content)

print(f"Successfully wrote {len(content)} characters to {pb_showcase}")
