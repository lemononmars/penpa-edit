-- Attach solver-created playable links to one exact booklet entry.
alter table public.wsc2026_puzzles
 add column booklet_ref text references public.wsc2026_booklet_entries(id);
create index on public.wsc2026_puzzles(group_id,booklet_ref);
